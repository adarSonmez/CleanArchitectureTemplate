...
namespace CleanArchitectureTemplate.Persistence.Migrations
{
    ...
    [Migration("20250511100708_CascadeDeleteBehaviour")]
    partial class CascadeDeleteBehaviour
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CleanArchitectureTemplate.Domain.Entities.Files.CategoryImageFile", b =>
                {
                    b.HasOne("CleanArchitectureTemplate.Domain.Entities.Shopping.Category", "Category")
                        .WithOne()
                        .HasForeignKey("CleanArchitectureTemplate.Domain.Entities.Files.CategoryImageFile", "CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CleanArchitectureTemplate.Domain.Entities.Files.FileDetails", "FileDetails")
                        .WithOne()
                        .HasForeignKey("CleanArchitectureTemplate.Domain.Entities.Files.CategoryImageFile", "FileDetailsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CleanArchitectureTemplate.Domain.Entities.Files.InvoiceFile", b =>
                {
                    b.HasOne("CleanArchitectureTemplate.Domain.Entities.Files.FileDetails", "FileDetails")
                        .WithOne()
                        .HasForeignKey("CleanArchitectureTemplate.Domain.Entities.Files.InvoiceFile", "FileDetailsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CleanArchitectureTemplate.Domain.Entities.Files.ProductImageFile", b =>
                {
                    b.HasOne("CleanArchitectureTemplate.Domain.Entities.Files.FileDetails", "FileDetails")
                        .WithOne()
                        .HasForeignKey("CleanArchitectureTemplate.Domain.Entities.Files.ProductImageFile", "FileDetailsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CleanArchitectureTemplate.Domain.Entities.Files.ReportFile", b =>
                {
                    b.HasOne("CleanArchitectureTemplate.Domain.Entities.Files.FileDetails", "FileDetails")
                        .WithOne()
                        .HasForeignKey("CleanArchitectureTemplate.Domain.Entities.Files.ReportFile", "FileDetailsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CleanArchitectureTemplate.Domain.Entities.Files.UserAvatarFile", b =>
                {
                    b.HasOne("CleanArchitectureTemplate.Domain.Entities.Files.FileDetails", "FileDetails")
                        .WithOne()
                        .HasForeignKey("CleanArchitectureTemplate.Domain.Entities.Files.UserAvatarFile", "FileDetailsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
